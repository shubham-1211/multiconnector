        ...
        */
        ...
        try {
            ...
            try {
                ...
                result.output.data[key].map((order) => {
                    ...
                    order.deliveryLine = order.deliveryLine.map((l) => {
                        console.log('info', 'Changed ' + l.product.codeProduct + ' to ' + productCodeToCALSId[l.product.codeProduct]);
                        return {
                            ...l,
            ...
            if (template.plugins.find(p => p.name === 'broker') && template.config.plugins.broker) {
                ...
                console.log('info', '2. Send received data to receiver data product ' + config.static.productCode + ', isTest=' + req.body.is_test);
